...
The pitch is: 5.0/12.
The peak height is 180.0 in.
The soffit height is 115.8125 in.
The drip edge is at 121.375 in.
The maximum height is 186.5 in.
The A and C Wall heights are 144.0 in.
The B Wall height is 120.0 in.
...
There are 2 pairs of hang rails at 112.0 in. each.
They were divided in half because the original length was longer than 216 in.
There are 2 pieces of Fascia at 118.0 in. each for the B wall
Their original length was more than 216 in. so they were cut in half.
There is one piece of Fascia at 174 in. for the A Wall and one piece at 174 for the C wall."""
        # Act
        main_window.results_view.calculate_button.click()

        assert main_window.results_view.results_view.toPlainText() == expected.strip()
...
The A Wall height is 120.0 in.
The C Wall height is 120.0 in.
...
The maximum height is 164.0 in.
