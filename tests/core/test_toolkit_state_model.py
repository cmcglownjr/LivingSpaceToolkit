...
class TestToolkitStateModel:
    ...
    def test_default_state(self):
        ...
        toolkit_2.pitch[SunroomSide.A_SIDE].pitch_value = '5'
        toolkit_2.pitch[SunroomSide.B_SIDE].pitch_value = '5'
    ...
    def test_check_calculation_ready_exception(self):
        ...
        toolkit.pitch[SunroomSide.A_SIDE].pitch_value = '5'
        toolkit.pitch[SunroomSide.C_SIDE].pitch_value = '5'
...
class TestStudioToolkitStateModel:
    ...
    def test_wall_height_pitch_check_calculation_ready(self):
        ...
        toolkit.pitch[SunroomSide.B_SIDE].pitch_value = '5'
        toolkit.overhang.length = '10'
        toolkit.roofing_type = RoofingType.ECO_GREEN
        toolkit.thickness.length = '3'
        toolkit.end_cuts = EndCutType.UNCUT_TOP_BOTTOM
        toolkit.wall_heights[(SunroomSide.B_SIDE, LengthType.WALL_HEIGHT)].length = "10'"
        toolkit.floor_walls[SunroomSide.A_SIDE].length = "8'"
    ...
    def test_wall_height_peak_height_check_calculation_ready(self):
        ...
        toolkit.end_cuts = EndCutType.UNCUT_TOP_BOTTOM
        toolkit.wall_heights[(SunroomSide.B_SIDE, LengthType.WALL_HEIGHT)].length = "10'"
        toolkit.wall_heights[(None, LengthType.PEAK_HEIGHT)].length = "12'"
        toolkit.floor_walls[SunroomSide.A_SIDE].length = "8'"
        toolkit.floor_walls[SunroomSide.B_SIDE].length = "10'"
        toolkit.floor_walls[SunroomSide.C_SIDE].length = "8'"
        # Assert
    ...
    def test_max_height_pitch_check_calculation_ready(self):
        ...
        toolkit.thickness.length = '3'
        toolkit.end_cuts = EndCutType.UNCUT_TOP_BOTTOM
        toolkit.wall_heights[(None, LengthType.MAX_HEIGHT)].length = "13'"
        toolkit.floor_walls[SunroomSide.A_SIDE].length = "8'"
        toolkit.floor_walls[SunroomSide.B_SIDE].length = "10'"
        toolkit.floor_walls[SunroomSide.C_SIDE].length = "8'"
        # Assert
    ...
    def test_soffit_height_peak_height_check_calculation_ready(self):
        ...
        toolkit.thickness.length = '3'
        toolkit.end_cuts = EndCutType.UNCUT_TOP_BOTTOM
        toolkit.wall_heights[(SunroomSide.B_SIDE, LengthType.SOFFIT_HEIGHT)].length = "10'"
...
class TestCathedralToolkitStateModel:
    ...
    def test_wall_height_pitch_check_calculation_ready(self):
        ...
        toolkit.thickness.length = '3'
        toolkit.end_cuts = EndCutType.UNCUT_TOP_BOTTOM
        toolkit.wall_heights[(SunroomSide.A_SIDE, LengthType.WALL_HEIGHT)].length = "10'"
        toolkit.wall_heights[(SunroomSide.C_SIDE, LengthType.WALL_HEIGHT)].length = "10'"
        toolkit.floor_walls[SunroomSide.A_SIDE].length = "8'"
        toolkit.floor_walls[SunroomSide.B_SIDE].length = "10'"
        toolkit.floor_walls[SunroomSide.C_SIDE].length = "8'"
        # Assert
    ...
    def test_soffit_height_peak_height_check_calculation_ready(self):
        ...
        toolkit.thickness.length = '3'
        toolkit.end_cuts = EndCutType.UNCUT_TOP_BOTTOM
        toolkit.wall_heights[(SunroomSide.A_SIDE, LengthType.SOFFIT_HEIGHT)].length = "10'"
        toolkit.wall_heights[(SunroomSide.C_SIDE, LengthType.SOFFIT_HEIGHT)].length = "10'"
        toolkit.wall_heights[(None, LengthType.PEAK_HEIGHT)].length = "13'"
        toolkit.floor_walls[SunroomSide.A_SIDE].length = "8'"
        toolkit.floor_walls[SunroomSide.B_SIDE].length = "10'"
        toolkit.floor_walls[SunroomSide.C_SIDE].length = "8'"
